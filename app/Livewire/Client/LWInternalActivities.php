...
class LWInternalActivities extends Component
{
    use WithPagination;
    public $muc = 'Hoạt động nội bộ';
    public $search = '';
    public $field = '';
    public $year = '';
    ...
    {
        return view('livewire.client.l-w-internal-activities', [
