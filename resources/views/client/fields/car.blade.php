                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <a class="post_link" href="javascript:;">
                            <img class="" src="{{ asset('img/banner/1 (6).jpg') }}" alt="image">
                        </a>
                    </div>
                        ...
                        <div class="future-goal-content__item">
                            <div class="future-goal p-lr-90 " data-aos="fade-up" data-aos-duration="700" data-aos-delay="50"
                                ...
                                <div class="desc font18 scrollbar-custom">
                                    <p style="text-align: justify;">Tập Đo&agrave;n Sản Xuất &ndash; Kinh Doanh &Ocirc;
                                        T&ocirc;, Ph&aacute;t Triển Bền Vững, Hội Nhập Khu Vực V&agrave; Thế Giới.</p>
                                </div>
                            ...
                            <div class="future-goal p-lr-90 last" data-aos="fade-up" data-aos-duration="700"
                                ...
                                <div class="desc font18 scrollbar-custom">
                                    <p style="text-align: justify;">Mang lại gi&aacute; trị cho kh&aacute;ch h&agrave;ng
                                        th&ocirc;ng qua sản phẩm v&agrave; dịch vụ với tinh thần tận t&acirc;m phục vụ.</p>
                                </div>
