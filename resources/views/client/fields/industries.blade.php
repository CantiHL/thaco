    ...
    <div class="field-of-activity">
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <a class="post_link" href="javascript:;">
                            <img class="" src="{{ asset('img/banner/1 (1).jpg') }}" alt="image">
                        </a>
                    </div>
                    ...
                    <div class="future-goal-content twoblock">
                        <div class="future-goal-content__item">
                            <div class="future-goal p-lr-90 " data-aos="fade-up" data-aos-duration="700" data-aos-delay="50"
                                ...
                                <div class="desc font18 scrollbar-custom">
                                    <p style="text-align: justify;">Trở thành tập đoàn hàng đầu Việt Nam về cơ khí chế
                                        tạo và công nghiệp hỗ trợ, hội nhập khu vực & thế giới.</p>
                                </div>
                        ...
                        <div class="future-goal-content__item">
                            <div class="future-goal p-lr-90 last" data-aos="fade-up" data-aos-duration="700"
                                ...
                                <div class="desc font18 scrollbar-custom">
                                    <p style="text-align: justify;">Mang lại giá trị cho khách hàng, đối tác, xã hội đóng
                                        góp quan trọng vào chiến lược phát triển ngành công nghiệp cơ khí và công nghiệp hỗ
                                        trợ Việt Nam.</p>
                                </div>
        ...
        <div class="activity-content-detail-slide">
            <div class="activity-content-detail-slide__detail-content">
                ...
                <div class="wrapper mb-40 mt-40 ">
                    <div class="main-content-left">
                        @isset($first_giacongcokhi)
                            <div class="content">
                                <h2 class="text-uppercase title font27" style="color: #00539a">
                                    {{ $first_giacongcokhi->title }}
                                </h2>

                                <p class="text font18 scrollbar-custom">
                                    {{ $first_giacongcokhi->description }}
                                </p>
                    ...
                    <div class="slide-wrapper main-content-right ">
                        <div class="swiper-container swiper-content-detail">
                            <div class="swiper-wrapper main-content-right">
                                @foreach ($giacongcokhi_diff as $item)
                                    <div class="swiper-slide">
                                        <div class="bg"></div>
                ...
                <div class="wrapper mb-40 mt-40 ">
                    <div class="main-content-left">
                        @isset($first_cungcapthep)
                            <div class="content">
                                <h2 class="text-uppercase title font27" style="color: #00539a">
                                    {{ $first_cungcapthep->title }}

                                </h2>
                                <p class="text font18 scrollbar-custom">
                                    {{ $first_cungcapthep->description }}
                                </p>
                    ...
                    <div class="nonslide-wrapper main-content-right  ">
                        <div class="activity-detail">
                            <div class="row item">
                                @foreach ($cuncapthep_diff as $item)
                                    <div class="col content">
                                        <div class="bg"></div>
                                        <img src="{{ Storage::url($item->image) }}" alt="slide" class="">
                ...
                <div class="wrapper mb-40 mt-40 ">
                    <div class="main-content-left">
                        @isset($first_linhkiencn)
                            <div class="content">
                                <h2 class="text-uppercase title font27" style="color: #00539a">
                                    {{ $first_linhkiencn->title }}
                                </h2>

                                <p class="text font18 scrollbar-custom">
                                    {{ $first_linhkiencn->description }}
                                </p>
                                <div class="control-slide  ">
                                    <div class="swiper-button-prev"></div>
                                    <div class="swiper-pagination pagination-field" style="background-color: #00539a">
                    ...
                    <div class="slide-wrapper main-content-right ">
                        <div class="swiper-container swiper-content-detail">
                            <div class="swiper-wrapper main-content-right">
                                @foreach ($linhkiencn_diff as $item)
                                    <div class="swiper-slide">
                                        <div class="bg"></div>
                                        <img src="{{ Storage::url($item->image) }}" alt="slide" class="bg-img">
                                        <h2 class="title text-uppercase text-light font27">
                ...
                <div class="wrapper mb-40 mt-40 ">
                    <div class="main-content-left">
                        @isset($first_tbnongnghiep)
                            <div class="content">
                                <h2 class="text-uppercase title font27" style="color: #00539a">
                                    {{ $first_tbnongnghiep->title }}

                                </h2>
                                <p class="text font18 scrollbar-custom">
                                    {{ $first_tbnongnghiep->description }}
                                </p>
                    ...
                    <div class="nonslide-wrapper main-content-right  ">
                        <div class="activity-detail">
                            <div class="row item">
                                @foreach ($tbnongnghiep_diff as $item)
                                    <div class="col content">
                                        <div class="bg"></div>
                                        <img src="{{ Storage::url($item->image) }}" alt="slide" class="">
                ...
                <div class="wrapper mb-40 mt-40 ">
                    <div class="main-content-left">
                        @isset($first_linhkienoto)
                            <div class="content">
                                <h2 class="text-uppercase title font27" style="color: #00539a">
                                    {{ $first_linhkienoto->title }}
                                </h2>

                                <p class="text font18 scrollbar-custom">
                                    {{ $first_linhkienoto->description }}
                                </p>
                                <div class="control-slide  ">
                                    <div class="swiper-button-prev"></div>
                                    <div class="swiper-pagination pagination-field" style="background-color: #00539a">
                    ...
                    <div class="slide-wrapper main-content-right ">
                        <div class="swiper-container swiper-content-detail">
                            <div class="swiper-wrapper main-content-right">
                                @foreach ($linhkienoto_diff as $item)
                                    <div class="swiper-slide">
                                        <div class="bg"></div>
                                        <img src="{{ Storage::url($item->image) }}" alt="slide" class="bg-img">
                                        <h2 class="title text-uppercase text-light font27">
                ...
                <div class="wrapper mb-40 mt-40 ">
                    <div class="main-content-left">
                        @isset($first_dvthietke)
                            <div class="content">
                                <h2 class="text-uppercase title font27" style="color: #00539a">
                                    {{ $first_dvthietke->title }}

                                </h2>
                                <p class="text font18 scrollbar-custom">
                                    {{ $first_dvthietke->description }}
                                </p>
                    ...
                    <div class="nonslide-wrapper main-content-right  ">
                        <div class="activity-detail">
                            <div class="row item">
                                @foreach ($dvthietke_diff as $item)
                                    <div class="col content">
                                        <div class="bg"></div>
                                        <img src="{{ Storage::url($item->image) }}" alt="slide" class="">
                        ...
                        <div class="swiper-container swiper-content-detail">
                            <div class="swiper-wrapper main-content-right">
                                @foreach ($giacongcokhi_diff as $item)
                                    <div class="swiper-slide">
                                        <div class="bg"></div>
                                        <img src="{{ asset('img/tamnhinauto-1-1.jpg') }}" alt="slide" class="bg-img">
                                        <h2 class="title text-uppercase text-light font27">
                                            {{ $item->title }}
                                        </h2>
                                        <div class="detail-wrap" onmouseover="this.style.background='#00539a'">
        ...
        <div class="activity-news mt-60 mb-60">
            <div class="activity-news__top container-customize mt-40 mb-40">
                ...
                <div class="readmore text-uppercase font-weight-bold">
                    <a href="https://thacoauto.vn/" style="color: #00539a">Xem thêm
                        <span>
